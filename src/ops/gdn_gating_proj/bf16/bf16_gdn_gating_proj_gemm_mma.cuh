...
// Qwen3.5-9B reuses the 35B CTA shape (BN64, two head tiles, eight warps) with twice the K
// depth, so every launch resource (registers, 24-KiB shared memory) matches the 35B profile.
