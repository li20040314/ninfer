...
// Qwen3.5-9B: the fused group(attention/query, attention/key) weight fed to attn_input_proj
// (4096 + 1024 rows). See n4096_k4096.cpp for why the generic Q4 GEMV variant is used instead of
