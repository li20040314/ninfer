...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 5> kK6144RouteStarts{2, 14, 33, 49, 193};
    constexpr std::array<std::int32_t, 10> kK6144RouteInteriors{1, 8, 24, 40, 56, 64, 96, 128, 129, 256};
